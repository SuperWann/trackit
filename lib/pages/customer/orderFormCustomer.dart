              ...
              LongButton(
                ...
                onPressed: () async {
                      ...
                      ? isValid()
                          ? customerProvider.isLoading
                              ...
                              : order = OrderCustomerModel(
                                ...
                                beratPaket: double.parse(_beratController.text),
                                namaPengirim: dataPengirim['nama_pengirim'],
                                teleponPengirim:
                                    dataPengirim['telepon_pengirim'],
                                detailAlamatPengirim:
                                    dataPengirim['detail_alamat_pengirim'],
                                namaPenerima: dataPenerima['nama_penerima'],
                                teleponPenerima:
                                    dataPenerima['telepon_penerima'],
                  ...
                  Future.delayed(const Duration(seconds: 2), () async {
                    ...
                    await customerProvider.createOrder(order!, context);
                  });
