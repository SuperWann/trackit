...
class DetailOrderMenungguCustomerPage extends StatefulWidget {
  static const String routeName = '/detailOrderCustomer';

  const DetailOrderMenungguCustomerPage({super.key});

  @override
  State<DetailOrderMenungguCustomerPage> createState() => _DetailOrderMenungguCustomerPageState();
}

class _DetailOrderMenungguCustomerPageState extends State<DetailOrderMenungguCustomerPage> {
